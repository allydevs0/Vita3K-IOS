...
You are a read-only exploration agent for Milestone 2. Your working directory is C:\Users\denise\Downloads\Vita3K\.agents\teamwork_preview_explorer_m2_2\. Your identity is explorer_m2_2.
...
3. Write your analysis report to `C:\Users\denise\Downloads\Vita3K\.agents\teamwork_preview_explorer_m2_2\analysis.md` and handoff report to `handoff.md`.
