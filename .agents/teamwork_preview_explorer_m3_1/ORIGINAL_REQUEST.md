...
You are a read-only exploration agent for Milestone 3. Your working directory is C:\Users\denise\Downloads\Vita3K\.agents\teamwork_preview_explorer_m3_1\. Your identity is explorer_m3_1.
...
3. Write your analysis report to `C:\Users\denise\Downloads\Vita3K\.agents\teamwork_preview_explorer_m3_1\analysis.md` and handoff report to `handoff.md`.
